<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
     <%@page import="com.soundarya.mediaApp.dao.impl.LikesImpl" %>
...
Enter the post ID:<input type="number" name="id" value="<%out.print(s); %>" required><br><br>
Enter your email:<input type="email" name="email" value="<%out.print(n); %>" required><br><br>
